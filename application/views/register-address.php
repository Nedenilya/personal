...
<!-- 
	...
	<div class="map-block">
		<div class="map-cont">
			<p class="map-cont__title">Введите aдрес</p>
			<p class="map-cont__text">Точный адрес, где предстоит работать</p>

			<form action="/register/employee/adress" method="post" class="map-form">
				<div class="input-map">
					<p class="input-map__text">Адрес</p>
					<input name="adress" type="text" placeholder="Москва, Театральный проезд, 5с10" id="suggest">
				</div>

				<div class="map-form__img-block" id="map">
					<!-- <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3Afd8313b22ac7c571d76a9b6c8c64fba26405827c36a5c791e64314952b926a37&amp;source=constructor" width="600" height="360" frameborder="0"></iframe> -->
					<!-- <script type="text/javascript" charset="utf-8" async src="https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3Adc9f6fe6b3df5431cb803ea99eb5ca0ed1b415a0b1d1ff5dc2d837a49517a5f4&amp;width=699&amp;height=395&amp;lang=ru_RU&amp;scroll=true&amp;apikey=31f3b753-dbcc-4ef6-a462-e7be2c43c19c"></script> -->
					<script src="https://api-maps.yandex.ru/2.1/?lang=ru_RU&amp;apikey=7323b15e-c437-42b8-a68f-ef809ca09083" type="text/javascript"></script> 
				</div>
		...
		<p class="map-block__text">Сервис «My Best Helper» собирает персональные данные для создания вашего аккаунта. Это позволит вам взаимодействовать с другими участниками сообщества. При необходимости вы всегда можете разорвать отношения с нашим сервисом.</p>
	</div>
	...
	<div class="block-bg" id="popapTwo">
		...
		<script src="/user_tpl/js/map.js"></script>
