...
<body>
	...
	<div class="reg-two">
		<form action="/register/employee/5" method="post" class="reg-form" enctype="multipart/form-data">
			...
			<div class="cont-form">
				...
				<div class="cont-form__item">
					...
					<div class="cont-form__info-block">
						<p class="info-block__title active">Загрузка фотографии</p>
						<p class="info-block__text">Загрузите собственное фото, на котором отчётливо видно ваше лицо.</p>

						<div class="info-block__input-block foto">
							<div class="input-block__block-img"><img id="preview" src="/user_tpl/img/form-icon/photo.svg" alt=""></div>
							<p id="to_hide" class="input-block__text">Перетащите фотографию сюда или</p>
							
							<div class="example-2">
								<div class="form-group">
									<input type="file" name="profile_image" size="200" id="file" class="input-file">
						...
						<button name="download" id="upload" class="cont-form__btn" type="submit">Продолжить<img src="/user_tpl/img/form-icon/f-btn.svg" alt=""></button>
					</div>
				</div>
