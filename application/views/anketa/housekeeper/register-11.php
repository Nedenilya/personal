...
<body>
	...
	<div class="reg-two">
		...
		<form action="/anketa/announcement/housekeeper" method="post" class="reg-form">
				...
				<div class="cont-form__item">
					...
					<div class="cont-form__info-block">
						...
						<div class="info-block__input-block textarea">
							...
							<textarea name="description">Опытная няня ищет работу вахтой с проживанием. Влияю на ребёнка положительно, действуя в его интересах, не в противоречии с требованиями родителей. Могу работать и домработницей или совмещать Хорошо готовлю.</textarea>
						</div>
