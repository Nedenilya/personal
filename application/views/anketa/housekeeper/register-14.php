...
<body>
	...
	<div class="reg-two">
		...
		<form action="/anketa/experience/housekeeper" method="post" class="reg-form">
			...
			<div class="cont-form">
				<div class="cont-form__item">
					...
					<div class="cont-form__info-block">
						<p class="info-block__title active">Общий стаж работы</p>

						<div class="block-input select three">
							<select name="experience" id="" class="block-input__select">
				...
				<div class="cont-form__item ">
					...
					<div class="cont-form__info-block">
						<p class="info-block__title">Опыт работы</p>
					</div>
				</div>
