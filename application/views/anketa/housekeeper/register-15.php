...
<div class="block_to_add">
						<p class="info-block__sub"><span class="countrycount"><img src="/user_tpl/img/form-icon/flag.svg" alt=""></span>Страна #1</p>
						...
						<div class="block-checkbox">
							...
							<div class="block-check width">
								...
								<div class="block-input select width">
									<input type="text" class="block-input__select height" name="nationality[]" list="citynames12">
									<datalist id="citynames12">
...
<option value="яхудои махали                       ">
						...
						<div class="block-checkbox">
							...
							<div class="block-check width">
								...
								<div class="block-input select width">
									<input type="text" class="block-input__select height" name="nationality[]" list="citynames13">
									<datalist id="citynames13">
										<option value="абадзехи                                           ">
<option value="абаза                                              ">
<option value="абазины                                            ">
<option value="абжуйцы                                            ">
