...
<body>
	...
	<div class="reg-two">
		...
		<form action="/anketa/announcement/nanny" method="post" class="reg-form">
				...
				<div class="cont-form__item">
					...
					<div class="cont-form__info-block">
						...
						<div class="info-block__input-block width">
							...
							<input name="article" type="text" placeholder="Няня-домработница для вашей семьи">
						</div>

						<div class="info-block__input-block textarea">
							<p class="input-block__text">Описание</p>
							<textarea name="description">Добрая, отзывчивая, без вредных привычек, люблю детей. Ищу работу няней. Образование среднее специальное педагогическое, два года работала в московской семье с мальчиком 2 лет. В обязанности входило: соблюдение режима дня ребенка, уход за детским гардеробом, уборка детской комнаты, приготовление пищи, развитие ребенка в соответствии с возрастом, прогулки. Люблю рисовать, знаю современные техники рисования. Владею немецким языком. Легко иду на контакт с детьми, умею их организовать, активно и интересно в игровой форме провести время. Умею вкусно готовить. Люблю свою работу, ответственно отношусь к исполнению обязанностей.</textarea>
						</div>
