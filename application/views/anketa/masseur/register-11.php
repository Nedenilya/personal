...
<body>
	...
	<div class="reg-two">
		...
		<form action="/anketa/announcement/masseur" method="post" class="reg-form">
				...
				<div class="cont-form__item">
					...
					<div class="cont-form__info-block">
						...
						<div class="info-block__input-block textarea">
							...
							<textarea name="description">В мои обязанности может входить снятие боли, расслабление организма, улучшение притока крови к мышцам, повышение тонуса кожи.</textarea>
						</div>
