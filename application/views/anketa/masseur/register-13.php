...
<body>
	...
	<div class="reg-two">
		...
		<form action="/anketa/masseur/3" method="post" class="reg-form">
					...
					<div class="cont-form__info-block">
						...
						<div class="input-radio center row mb">
							...
							<label class="label-radio center">
								<input value="Есть" type="radio" name="r1" class="label-radio__input">
						...
						<div class="block-checkbox two">
							...
							<div class="block-check">
								<p class="block-check__title">Кому вы готовы делать массаж?</p>
								<label class="wrapper-login01">
									<input name="r2" value="Мужчинам" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Мужчинам</span>
								</label>
								<label class="wrapper-login01">
									<input name="r3" value="Женщинам" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Женщинам</span>
								</label>
							</div>
						</div>
						...
						<div class="block-checkbox two">
							...
							<div class="block-check">
								...
								<label class="wrapper-login01">
									<input name="r4" value="" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Массаж лица</span>
								</label>
								<label class="wrapper-login01">
									<input name="r5" value="Антицеллюлитный" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Антицеллюлитный</span>
								</label>
								<label class="wrapper-login01">
									<input name="r6" value="Лимфодренажный" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Лимфодренажный</span>
								</label>
								<label class="wrapper-login01">
									<input name="r7" value="Классический" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Классический</span>
								</label>
								<label class="wrapper-login01">
									<input name="r8" value="Медицинский" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Медицинский</span>
								</label>
								<label class="wrapper-login01">
									<input name="r9" value="Баночный" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Баночный</span>
								</label>
								<label class="wrapper-login01">
									<input name="r10" value="Спортивный" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Спортивный</span>
								</label>
								<label class="wrapper-login01">
									<input name="r11" value="Скульптурный" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Скульптурный</span>
								</label>
								<label class="wrapper-login01">
									<input name="r12" value="Тайский" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Тайский</span>
								</label>
								<label class="wrapper-login01">
									<input name="r13" value="Китайский" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Китайский</span>
								</label>
								<label class="wrapper-login01">
									<input name="r14" value="Балийский" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Балийский</span>
								</label>
								<label class="wrapper-login01">
									<input name="r15" value="Индийский" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Индийский</span>
								</label>
								<label class="wrapper-login01">
									<input name="r16" value="Другое" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
