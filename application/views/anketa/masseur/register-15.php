...
<body>
	...
	<div class="reg-two">
		...
		<form action="/anketa/work_experience/masseur" method="post" class="reg-form">
						...
						<div class="block-checkbox">
							...
							<div class="block-check width">
								...
								<div class="block-input select width">
									<input type="text" class="block-input__select height" name="nationality[]" list="citynames1">
								<datalist id="citynames1">
...
<option value="яхудои махали                       ">
						...
						<div class="block-checkbox">
							...
							<div class="block-check width">
								...
								<div class="block-input select width">
									<input type="text" class="block-input__select height" name="nationality[]" list="citynames2">
