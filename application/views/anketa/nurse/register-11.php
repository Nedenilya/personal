...
<body>
	...
	<div class="reg-two">
		...
		<form action="/anketa/announcement/nurse" method="post" class="reg-form">
				...
				<div class="cont-form__item">
					...
					<div class="cont-form__info-block">
						...
						<div class="info-block__input-block textarea">
							...
							<textarea name="description">Здравствуйте! Меня зовут Татьяна. Имею 19-летний опыт работы воспитателем. Я добрая, отзывчивая, энергичная и целеустремленная оптимистка. Есть опыт работы и в других сферах жизни, а именно, спорт, фитнесс, лечебная физкультура, массаж, реабилитация, путешествия, туризм, маркетинг, цветоводство, организация досуга, кулинария. Есть опыт работы компаньонкой, сиделкой, в том числе и в доме престарелых. Буду рада принести пользу вам и вашей семье.</textarea>
						</div>
