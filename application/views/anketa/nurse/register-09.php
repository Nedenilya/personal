...
<body>
			...
			<div class="header-cont">
				...
				<div class="header-cont__header-right">
					...
					<div class="header-cont__entrance-block reg">
						<a href="/auth/index" class="header-cont__entrancelink"><img src="/user_tpl/img/login-icon.svg" alt="">Профиль</a>
	...
	<div class="reg-two">
		...
		<form action="/anketa/nurse/2" method="post" class="reg-form">
			...
			<div class="cont-form">
						...
						<div class="block-checkbox">
							...
							<div class="block-check">
								<label class="wrapper-login01">
									<input name="r2" value="Сиделка на ночь" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Сиделка на ночь</span>
								</label>
								<label class="wrapper-login01">
									<input name="r3" value="Приходящая" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Приходящая</span>
								</label>
								<label class="wrapper-login01">
									<input name="r4" value="Вахта" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Вахта</span>
								</label>
								<label class="wrapper-login01">
									<input name="r5" value="Сменный график" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Сменный график</span>
								</label>
							</div>
						</div>
				...
				<div class="cont-form__item">
					...
					<div class="cont-form__info-block">
						<p class="info-block__title">Сиделка на ночь</p>
					</div>
				</div>
				...
				<div class="cont-form__item">
					...
					<div class="cont-form__info-block">
						<p class="info-block__title">Приходящая</p>
					</div>
				</div>
				...
				<div class="cont-form__item">
					<div class="cont-form__number"><p>3</p></div>
					<div class="cont-form__info-block">
						<p class="info-block__title">Вахта</p>
					</div>
				</div>
				...
				<div class="cont-form__item">
					...
					<div class="cont-form__info-block">
						<p class="info-block__title">Сменный график</p>
					</div>
				</div>
			</div>
		</form>
...
<div class="block-bg" id="popapTwo">
		<div class="popap-two">
			...
			<a href="/auth/index" class="popap-two__link">Войти</a>
		</div>
	</div>
