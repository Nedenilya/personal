...
<body>
	...
	<div class="reg-two">
		...
		<p class="reg-two__title">Заполните анкету</p>
		<p class="reg-two__text">Выберите подходящую вакансию из вариантов ниже.</p>

		<div class="reg-two__block-jobs">
			<div class="block-jobs__item">
				<p class="block-jobs__title">Няня-помощница</p>
				<p class="block-jobs__text">Может осуществлять полный уход за детьми, проводить уборку дома и готовить еду.</p>
				<a href="/anketa/nanny/1" class="block-jobs__link">Выбрать</a>
			</div>
			<div class="block-jobs__item">
				<p class="block-jobs__title">Домработница</p>
				<p class="block-jobs__text">Может выполнить любую работу по дому: уборку, стирку, глажку, уход за гардеробом, помощь на кухне.</p>
				<a href="/anketa/housekeeper/1" class="block-jobs__link">Выбрать</a>
			</div>
			<div class="block-jobs__item">
				<p class="block-jobs__title">Преподаватель</p>
				<p class="block-jobs__text">Преподаватель иностранного языка для обучения вашего ребёнка, для работы в школе или детском саду.</p>
				<a href="/anketa/teacher/1" class="block-jobs__link">Выбрать</a>
			</div>
			<div class="block-jobs__item">
				<p class="block-jobs__title">Массажист</p>
				<p class="block-jobs__text">Специалист, выполняющий массаж: оздоровительный, лечебный, расслабляющий и другие виды. </p>
				<a href="/anketa/masseur/1" class="block-jobs__link">Выбрать</a>
			</div>
			<div class="block-jobs__item">
				<p class="block-jobs__title">Сиделка</p>
				<p class="block-jobs__text">Уход за больным или пожилым человеком, инвалидом, людьми с ограниченными возможностями.</p>
				<a href="/anketa/nurse/1" class="block-jobs__link">Выбрать</a>
			</div>
		</div>
