...
<body>
	...
	<div class="control-block">
		<ul class="control-menu">
			...
			<li class="control-menu__item"><a href="" class="control-menu__link"><img src="/user_tpl/img/form-icon/c-2.svg" alt="">Новые кандидаты</a></li>
			<li class="control-menu__item"><a href="" class="control-menu__link"><img src="/user_tpl/img/form-icon/c-3.svg" alt="">Сообщения</a></li>
		...
		<!-- <p class="control-block__text">Здесь вы можете управлять <a href="#">Премиум-подпиской</a>, добавлять и изменять резюме.</p> -->
		...
		<div class="control-item">
			<div class="control-item__item">
				...
				<!-- <a href="" class="control-item__link">Купить Премиум-подписку</a> -->
			</div>
			<div class="control-item__item">
				<div class="block-text">
				...
				<a href="" class="control-item__link">Открыть ответы на вопросы </a>
			</div>
		</div>

		<div class="summary-block">
			<p class="summary-block__title">Ваши резюме</p>

			<div class="summary-block__item">
				<p class="summary-block__position">Няня-помощница</p>
				<a href="#" class="summary-block__red"><img src="/user_tpl/img/form-icon/red.svg" alt="">Редактировать</a>
				<a href="#" class="summary-block__del"><img src="/user_tpl/img/form-icon/del.svg" alt=""></a>
			</div>

			<a href="#" class="summary-block__link"><img src="/user_tpl/img/form-icon/plus-2.svg" alt="">Добавить новую</a>
		</div>
