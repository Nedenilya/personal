...
<!-- 
	...
	<div class="reg-block login">
		<div class="reg-cont">
			...
			<form action="/auth/login" method="post" class="reg-form">
			...
			<p class="reg-cont__quest login">Уже есть аккаунт? <a href="/pages/login">Войти</a></p>
			<p class="reg-cont__quest popOne1Open">Нет аккаунта? <a href="#">Зарегистрироваться</a></p>
		</div>
	</div>
