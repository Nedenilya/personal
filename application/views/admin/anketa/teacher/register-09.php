...
<body>
	...
	<div class="reg-two">
		...
		<form action="/anketa/teacher/2" method="post" class="reg-form">
						...
						<div class="block-checkbox">
							...
							<div class="block-check">
								<label class="wrapper-login01">
									<input name="r2" value="Работа в школе" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Работа в школе</span>
								</label>
								<label class="wrapper-login01">
									<input name="r3" value="Работа в детском саду" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Работа в детском саду</span>
								</label>
								<label class="wrapper-login01">
									<input name="r4" value="Дистанционно (по Скайпу)" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Дистанционно (по Скайпу)</span>
								</label>
								<label class="wrapper-login01">
									<input name="r5" value="Выезд к ученику" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Выезд к ученику</span>
								</label>
								<label class="wrapper-login01">
									<input name="r6" value="У педагога" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">У педагога</span>
								</label>
							</div>
						</div>
