...
<body>
	...
	<div class="reg-two">
		...
		<form action="/admin/change/nanny" method="post" class="reg-form">
			<div class="cont-form">
						...
						<div class="block-checkbox">
							...
							<div class="block-check">
								<label class="wrapper-login01">
									<input name="r2" value="Няня на час" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Няня на час</span>
								</label>
								<label class="wrapper-login01">
									<input name="r3" value="Няня на вахту или смену" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Няня на вахту или смену</span>
								</label>
								<label class="wrapper-login01">
									<input name="r4" value="Няня сопровождающая (в школу, на занятия)" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Няня сопровождающая (в школу, на занятия)</span>
								</label>
								<label class="wrapper-login01">
									<input name="r5" value="Няня забирать из садика" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Няня забирать из садика (до прихода родителей)</span>
								</label>
								<label class="wrapper-login01">
									<input name="r6" value="Няня на выходные" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
