...
<!-- 
	...
	<div class="reg-block login">
		<div class="reg-cont">
			<p class="reg-cont__title">Вход в аккаунт</p>

			<form action="/admin/login" method="post" class="reg-form">
				...
				<div class="reg-input">
					<p class="reg-input__text">Доступ</p>
					<select name="type">
			...
			<p class="reg-cont__quest login">Уже есть аккаунт? <a href="login.html">Войти</a></p>
			<p class="reg-cont__quest">Нет аккаунта? <a href="reg.html">Зарегистрироваться</a></p>
		</div>
	</div>
