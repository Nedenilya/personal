...
<body>
	...
	<div class="reg-two">
		...
		<form action="/register/anketas/4/nanny" method="post" class="reg-form">
			...
			<div class="cont-form">
				...
				<div class="cont-form__item">
					...
					<div class="cont-form__info-block">
						...
						<p class="output-block__title">Площадь квартиры/дома (м2)</p>
						<div class="info-block__input-block">
							<p class="input-block__text">Площадь</p>
							<input name="sqr" type="text" placeholder="Введите площадь квартиры">
						</div>
						...
						<div class="info-block__input-block width">
							...
							<input name="article" type="text" placeholder="Ищем няню с высшим образованием">
						</div>

						<div class="info-block__input-block textarea">
							<p class="input-block__text">Описание</p>
							<textarea name="description" placeholder="Мы ищем няню с высшим педагогическим образованием для 2-х детей возрастом 3 и 7 лет. В обязанности няни будет входить: соблюдение режима дня ребенка, уход за детским гардеробом, уборка детской комнаты, приготовление пищи, развитие ребенка в соответствии с возрастом, прогулки."></textarea>
						</div>
