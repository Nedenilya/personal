...
<div class="mob-menu reg" id="mobMenu">
	...
	<div class="reg-two">
		...
		<form action="/register/anketas/3/nanny" method="post" class="reg-form">
						...
						<div class="calendar-block">
							...
							<div class="block-select">
								<div class="block-input select block-s">
									<select name="start_time" id="" class="block-input__select">
								...
								<div class="block-input select block-s">
									<select name="end_time" id="" class="block-input__select">
										<option value="06:00">06:00</option>
										<option value="07:00">07:00</option>
										<option value="08:00">08:00</option>
										<option value="09:00">09:00</option>
							...
							<div class="block-input select calen">
								<input type="start_date" style="outline: none;" name="start_date" id="" class="block-input__select">
