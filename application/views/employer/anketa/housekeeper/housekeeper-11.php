...
<body>
	...
	<div class="reg-two">
		...
		<form action="/register/anketas/2/housekeeper" method="post" class="reg-form">
						...
						<div class="block-checkbox">
							...
							<div class="block-check">
								<label class="wrapper-login01">
									<input name="r2" value="Горничная" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Горничная</span>
								</label>
								<label class="wrapper-login01">
									<input name="r3" value="Помощник\ца по хозяйству"  class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Помощник\ца по хозяйству</span>
								</label>
								<label class="wrapper-login01">
									<input name="r4" value="Разовая уборка"  class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Разовая уборка</span>
								</label>
								<label class="wrapper-login01">
									<input name="r5" value="Уборщица в офис"  class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Уборщица в офис</span>
								</label>
								<label class="wrapper-login01">
									<input name="r6" value="Уборщица в кофе"  class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Уборщица в кофе</span>
								</label>
								<label class="wrapper-login01">
									<input name="r7" value="Генеральная уборка"  class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Генеральная уборка</span>
								</label>
								<label class="wrapper-login01">
									<input name="r8" value="Домработница с проживанием"  class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Домработница с проживанием</span>
								</label>
							</div>
						</div>
