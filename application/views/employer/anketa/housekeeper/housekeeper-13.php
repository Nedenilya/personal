...
<body>
	...
	<div class="reg-two">
		...
		<form action="/register/anketas/4/housekeeper" method="post" class="reg-form">
					...
					<div class="cont-form__info-block">
						...
						<div class="block-checkbox">
							...
							<div class="block-check">
								<p class="block-check__title">Площадь квартиры (дома)</p>
								<label class="wrapper-login01">
									<input name="r3" value="До 50 кв.м" class="checkbox-login01" type="radio">
									<span class="style-login01"></span>
									<span class="text-login01">До 50 кв.м</span>
								</label>
								<label class="wrapper-login01">
									<input name="r3" value="От 51 до 80 кв.м" class="checkbox-login01" type="radio">
									<span class="style-login01"></span>
									<span class="text-login01">От 51 до 80 кв.м</span>
								</label>
								<label class="wrapper-login01">
									<input name="r3" value="От 81 до 110 кв.м" class="checkbox-login01" type="radio">
									<span class="style-login01"></span>
									<span class="text-login01">От 81 до 110 кв.м</span>
								</label>
								<label class="wrapper-login01">
									<input name="r3" value="От 111 до 140 кв.м" class="checkbox-login01" type="radio">
									<span class="style-login01"></span>
									<span class="text-login01">От 111 до 140 кв.м</span>
								</label>
								<label class="wrapper-login01">
									<input name="r3" value="Подростки (от 10 до 18 лет)" class="checkbox-login01" type="radio">
									<span class="style-login01"></span>
									<span class="text-login01">Подростки (от 10 до 18 лет)</span>
								</label>
								<label class="wrapper-login01">
									<input name="r3" value="От 141 до 170 кв.м" class="checkbox-login01" type="radio">
									<span class="style-login01"></span>
									<span class="text-login01">От 141 до 170 кв.м</span>
								</label>
								<label class="wrapper-login01">
									<input name="r3" value="От 171 до 200 кв.м" class="checkbox-login01" type="radio">
									<span class="style-login01"></span>
									<span class="text-login01">От 171 до 200 кв.м</span>
								</label>
								<label class="wrapper-login01">
									<input name="r3" value="От 201 кв.м" class="checkbox-login01" type="radio">
									<span class="style-login01"></span>
									<span class="text-login01">От 201 кв.м</span>
								</label>
							</div>
						</div>
						...
						<div class="block-checkbox two">
							...
							<div class="block-check">
								<p class="block-check__title">Обязанности домработницы:</p>
								<label class="wrapper-login01">
									<input name="r11" value="Уборка жилых комнат" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Уборка жилых комнат</span>
								</label>
								<label class="wrapper-login01">
									<input name="r12" value="Уборка ванной и санузла" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Уборка ванной и санузла</span>
								</label>
								<label class="wrapper-login01">
									<input name="r13" value="Уборка кухни и мытье посуды" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Уборка кухни и мытье посуды</span>
								</label>
								<label class="wrapper-login01">
									<input name="r14" value="Стирка и глажка белья" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Стирка и глажка белья</span>
								</label>
								<label class="wrapper-login01">
									<input name="r15" value="Уход за одеждой и обувью" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Уход за одеждой и обувью</span>
								</label>
								<label class="wrapper-login01">
									<input name="r16" value="Чистка ковров" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Чистка ковров</span>
								</label>
								<label class="wrapper-login01">
									<input name="r17" value="Уход за мебелью" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Уход за мебелью</span>
								</label>
								<label class="wrapper-login01">
									<input name="r18" value="Мытье окон" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Мытье окон</span>
								</label>
								<label class="wrapper-login01">
									<input name="r19" value="Приготовление еды" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Приготовление еды</span>
								</label>
								<label class="wrapper-login01">
									<input name="r20" value="Уход за цветами и растениями" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Уход за цветами и растениями</span>
								</label>
								<label class="wrapper-login01">
									<input name="r21" value="Уход за домашними животными" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Уход за домашними животными</span>
								</label>
							</div>
						</div>
						...
						<div class="block-checkbox">
							...
							<div class="block-check">
								<p class="block-check__title">Дополнительно:</p>
								<label class="wrapper-login01">
									<input name="r24" value="Парогенератор" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Парогенератор</span>
								</label>
								<label class="wrapper-login01">
									<input name="r25" value="VIP-гардероб" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">VIP-гардероб</span>
								</label>
								<label class="wrapper-login01">
									<input name="r26" value="Уход за различными поверхностями" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Уход за различными поверхностями</span>
								</label>
								<label class="wrapper-login01">
									<input name="r27" value="Банкетная сервировка стола" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
						...
						<div class="info-block__input-block width">
							...
							<input name="article" type="text" placeholder="Горничная">
						</div>

						<div class="info-block__input-block textarea">
							<p class="input-block__text">Описание</p>
							<textarea name="description" placeholder="Мы ищем горничную."></textarea>
						</div>
