...
<head>
	...
	<!-- fonts -->
	<link href="https://fonts.googleapis.com//user_tpl/css2?family=Playfair+Display:wght@700&family=Rubik:wght@400;500&display=swap" rel="stylesheet">
...
<body>
	...
	<div class="reg-two">
		...
		<form action="/register/anketas/1/housekeeper" method="post" class="reg-form">
