...
<body>
	...
	<div class="reg-two">
		...
		<form action="/register/anketas/4/masseur" method="post" class="reg-form">
				...
				<div class="cont-form__item">
					...
					<div class="cont-form__info-block">
						...
						<div class="input-radio center row mb">
							...
							<label class="label-radio center">
								<input type="radio" name="r4" value="Есть" class="label-radio__input">
								<span class="label-radio__fake"></span>
							...
							<label class="label-radio center">
								<input type="radio" name="r4" value="Нет" class="label-radio__input">
								<span class="label-radio__fake"></span>
						...
						<div class="block-checkbox two">
							...
							<div class="block-check">
								...
								<label class="wrapper-login01">
									<input name="r26" value="Мужчинам" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Мужчинам</span>
								</label>
								<label class="wrapper-login01">
									<input name="r27" value="Женщинам" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
						...
						<div class="block-checkbox">
							...
							<div class="block-check">
								...
								<label class="wrapper-login01">
									<input name="r11" value="" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Массаж лица</span>
								</label>
								<label class="wrapper-login01">
									<input name="r12" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Антицеллюлитный</span>
								</label>
								<label class="wrapper-login01">
									<input name="r13" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Лимфодренажный</span>
								</label>
								<label class="wrapper-login01">
									<input name="r14" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Классический</span>
								</label>
								<label class="wrapper-login01">
									<input name="r15" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Медицинский</span>
								</label>
								<label class="wrapper-login01">
									<input name="r16" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Баночный</span>
								</label>
								<label class="wrapper-login01">
									<input name="r17" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Спортивный</span>
								</label>
								<label class="wrapper-login01">
									<input name="r18" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Скульптурный</span>
								</label>
								<label class="wrapper-login01">
									<input name="r19" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Тайский</span>
								</label>
								<label class="wrapper-login01">
									<input name="r20" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Китайский</span>
								</label>
								<label class="wrapper-login01">
									<input name="r21" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Балийский</span>
								</label>
								<label class="wrapper-login01">
									<input name="r22" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Индийский</span>
								</label>
								<label class="wrapper-login01">
									<input name="r23" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
						...
						<div class="info-block__input-block width">
							...
							<input name="article" type="text" placeholder="Массажист">
						</div>

						<div class="info-block__input-block textarea">
							<p class="input-block__text">Описание</p>
							<textarea name="description" placeholder="Мы ищем массажиста."></textarea>
						</div>
