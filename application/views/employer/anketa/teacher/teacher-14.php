			...
			<div class="cont-form">
				...
				<div class="cont-form__item">
					...
					<div class="cont-form__info-block">
						...
						<div class="block-input select">
							<select name="old_exp" id="" class="block-input__select">
								<option value="Дошкольники">Дошкольники</option>
								<option value="1-3 года">1-3 года</option>
								<option value="4-9 года">4-9 года</option>
								<option value="10-11 лет">10-11 лет</option>
								<option value="Студенты и взрослые">Студенты и взрослые</option>
							</select>
							<p class="block-input__text">Опыт работа с возростными группами</p>
						</div>
