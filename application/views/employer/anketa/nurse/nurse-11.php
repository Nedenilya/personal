...
<body>
	...
	<div class="reg-two">
		...
		<form action="/register/anketas/2/nurse" method="post" class="reg-form">
						...
						<div class="block-checkbox">
							...
							<div class="block-check">
								<label class="wrapper-login01">
									<input name="r2" value="Сиделка" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Сиделка</span>
								</label>
								<label class="wrapper-login01">
									<input name="r3" value="Сиделка для пожилого человека" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Сиделка для пожилого человека</span>
								</label>
								<label class="wrapper-login01">
									<input name="r4" value="Сиделка с проживанием \ вахтой" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Сиделка с проживанием \ вахтой</span>
								</label>
								<label class="wrapper-login01">
									<input name="r5" value="Сиделка на дом" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Сиделка на дом</span>
								</label>
								<label class="wrapper-login01">
									<input name="r6" value="Сиделка на ночь" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Сиделка на ночь</span>
								</label>
								<label class="wrapper-login01">
									<input name="r7" value="Сиделка в больницу" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Сиделка в больницу</span>
								</label>
								<label class="wrapper-login01">
									<input name="r8" value="Медсестра сиделка" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Медсестра сиделка</span>
								</label>
								<label class="wrapper-login01">
									<input name="r9" value="Сиделка мужчина" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
