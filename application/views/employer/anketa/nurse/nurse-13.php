...
<body>
	...
	<div class="reg-two">
		...
		<form action="/register/anketas/4/nurse" method="post" class="reg-form">
				...
				<div class="cont-form__item">
					...
					<div class="cont-form__info-block">
						...
						<div class="info-block__input-block width">
							...
							<input name="article" type="text" placeholder="Сиделка">
						</div>

						<div class="info-block__input-block textarea">
							<p class="input-block__text">Описание</p>
							<textarea name="description" placeholder="Мы ищем сиделку."></textarea>
						</div>

						<div class="block-checkbox">

							<div class="block-check">
								<p class="block-check__title">Выберите категорию:</p>
								<label class="wrapper-login01">
									<input name="c1" value="Медсестра-сиделка" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Медсестра-сиделка</span>
								</label>
								<label class="wrapper-login01">
									<input name="c2" value="Сиделка на частичную занятость" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Сиделка на частичную занятость</span>
								</label>
								<label class="wrapper-login01">
									<input name="c3" value="Сиделка на сменный график" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Сиделка на сменный график</span>
								</label>
								<label class="wrapper-login01">
									<input name="c4" value="Сиделка на полный день (5\2,6\1) без проживания" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Сиделка на полный день (5\2,6\1) без проживания</span>
								</label>
								<label class="wrapper-login01">
									<input name="c5" value="Сиделка мужчина" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Сиделка мужчина</span>
								</label>
								<label class="wrapper-login01">
									<input name="c6" value="Другое" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Другое</span>
								</label>
							</div>
						</div>
						...
						<div class="block-checkbox">
							...
							<div class="block-check">
								<p class="block-check__title">Возраст подопечного (больного):</p>
								<label class="wrapper-login01">
									<input name="age1" value="До 6 лет" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">До 6 лет</span>
								</label>
								<label class="wrapper-login01">
									<input name="age2" value="От 6 до 18 лет" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">От 6 до 18 лет</span>
								</label>
								<label class="wrapper-login01">
									<input name="age3" value="От 18 до 55 лет" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">От 18 до 55 лет</span>
								</label>
								<label class="wrapper-login01">
									<input name="age4" value="Старше 55 лет" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
						...
						<div class="block-checkbox">
							...
							<div class="block-check">
								<p class="block-check__title">Требуется опыт работы с больными по диагнозам:</p>
								<label class="wrapper-login01">
									<input name="ill1" value="Аутизм" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Аутизм</span>
								</label>
								<label class="wrapper-login01">
									<input name="ill2" value="Деменция (болезнь Альцгеймера)" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Деменция (болезнь Альцгеймера)</span>
								</label>
								<label class="wrapper-login01">
									<input name="ill3" value="ДЦП" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">ДЦП</span>
								</label>
								<label class="wrapper-login01">
									<input name="ill4" value="Инсульт (постинсультная реабилитация)" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Инсульт (постинсультная реабилитация)</span>
								</label>
								<label class="wrapper-login01">
									<input name="ill5" value="Инфаркт (постинфарктная реабилитация)" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Инфаркт (постинфарктная реабилитация)</span>
								</label>
								<label class="wrapper-login01">
									<input name="ill6" value="Онкология (рак)" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Онкология (рак)</span>
								</label>
								<label class="wrapper-login01">
									<input name="ill7" value="Паркинсонизм (болезнь Паркинсона)" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Паркинсонизм (болезнь Паркинсона)</span>
								</label>
								<label class="wrapper-login01">
									<input name="ill8" value="Психические расстройства" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Психические расстройства</span>
								</label>
								<label class="wrapper-login01">
									<input name="ill9" value="Различные травмы (ампутация)" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Различные травмы (ампутация)</span>
								</label>
								<label class="wrapper-login01">
									<input name="ill10" value="Сахарный диабет" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Сахарный диабет</span>
								</label>
								<label class="wrapper-login01">
									<input name="ill11" value="Эпилепсия" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
						...
						<div class="block-checkbox">
							...
							<div class="block-check">
								<p class="block-check__title">Навыки:</p>
								<label class="wrapper-login01">
									<input name="r11" value="Внутривенные инъекции, капельницы" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Внутривенные инъекции, капельницы</span>
								</label>
								<label class="wrapper-login01">
									<input name="r12" value="Гигиена больного" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Гигиена больного</span>
								</label>
								<label class="wrapper-login01">
									<input name="r13" value="Лечебный массаж" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Лечебный массаж</span>
								</label>
								<label class="wrapper-login01">
									<input name="r14" value="Подкожные и внутремышечные инъекции" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Подкожные и внутремышечные инъекции</span>
								</label>
								<label class="wrapper-login01">
									<input name="r15" value="Послеоперационный уход" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Послеоперационный уход</span>
								</label>
								<label class="wrapper-login01">
									<input name="r16" value="Обработка ран, перевязка" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Обработка ран, перевязка</span>
								</label>
							</div>
						</div>
						...
						<div class="block-checkbox">
							...
							<div class="block-check">
								<p class="block-check__title">Дополнительные обязанности:</p>
								<label class="wrapper-login01">
									<input name="r24" value="Приготовление еды" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Приготовление еды</span>
								</label>
								<label class="wrapper-login01">
									<input name="r25" value="Уборка помещения" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Уборка помещения</span>
								</label>
								<label class="wrapper-login01">
									<input name="r26" value="Стирка и глажка" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Стирка и глажка</span>
								</label>
								<label class="wrapper-login01">
									<input name="r27" value="Покупка продуктов и медикаментов" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Покупка продуктов и медикаментов</span>
								</label>
								<label class="wrapper-login01">
									<input name="r28" value="Прогулки" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Прогулки</span>
								</label>
								<label class="wrapper-login01">
									<input name="r29" value="Разовые поручения" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
