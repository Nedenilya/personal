...
<!-- 
	...
	<div class="reg-block">
		<div class="reg-cont">
			<p class="reg-cont__title">Регистрация</p>
			<p class="reg-cont__text">Найдите помощника прямо сейчас совершенно бесплатно.</p>

			<form action="/register/step/employer/1" method="post" class="reg-form">
				<div class="reg-input">
					<p class="reg-input__text">Фамилия</p>
					<input name="surname" type="text" placeholder="Введите фамилию">
				</div>

				<div class="reg-input">
					<p class="reg-input__text">Имя</p>
					<input name="name" type="text" placeholder="Введите имя">
				</div>

				<div class="reg-input">
					<p class="reg-input__text">Отчество</p>
					<input name="thirdname" type="text" placeholder="Введите отчество">
				</div>

				<div class="reg-input">
					<p class="reg-input__text">E-mail</p>
					<input name="mail" type="email" placeholder="mybesthelper@gmail.com">
				</div>

				<div class="reg-input">
					<p class="reg-input__text">Пароль</p>
					<input name="pass" type="password" placeholder="••••••••" id="password-input">
			...
			<p class="reg-cont__quest">Уже есть аккаунт? <a href="login.html">Войти</a></p>
			<p class="reg-cont__text-two">Нажимая кнопку «Зарегистрироваться», вы подтверждаете своё согласие с нашим <a href="">пользовательским соглашением.</a></p>
		</div>

		<p class="reg-block__text">Сервис «My Best Helper» собирает персональные данные для создания вашего аккаунта. Это позволит вам взаимодействовать с другими участниками сообщества. При необходимости вы всегда можете разорвать отношения с нашим сервисом.</p>
	</div>
