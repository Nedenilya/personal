...
<body>
	...
	<div class="reg-two">
		...
		<form action="/register/anketas/2/nanny" method="post" class="reg-form">
					...
					<div class="cont-form__info-block">
						...
						<div class="input-radio">
							<label class="label-radio">
								<input type="radio" name="r1" value="full" class="label-radio__input">
							...
							<label class="label-radio">
								<input type="radio" name="r1" value="partial" class="label-radio__input">
								<span class="label-radio__fake"></span>
						...
						<div class="block-checkbox">
							...
							<div class="block-check">
								<label class="wrapper-login01">
									<input name="hour_nanny" value="Няня на час" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Няня на час</span>
								</label>
								<label class="wrapper-login01">
									<input name="shift_nanny" value="Няня на вахту или смену" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Няня на вахту или смену</span>
								</label>
								<label class="wrapper-login01">
									<input name="accompanying_nanny" value="Няня сопровождающая (в школу, на занятия)" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Няня сопровождающая (в школу, на занятия)</span>
								</label>
								<label class="wrapper-login01">
									<input name="kindergarten_nanny" value="Няня забирать из садика (до прихода родителей)" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Няня забирать из садика (до прихода родителей)</span>
								</label>
								<label class="wrapper-login01">
									<input name="weekend_nanny" value="Няня на выходные" class="checkbox-login01" type="checkbox">
									<span class="style-login01"></span>
									<span class="text-login01">Няня на выходные</span>
								</label>
							</div>
						</div>
