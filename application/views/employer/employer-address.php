...
<!-- 
	...
	<div class="map-block"> 
		<div class="map-cont">
			<p class="map-cont__title">Введите адрес</p>
			<p class="map-cont__text">очный адрес, где предстоит работать</p>

			<form action="/register/anketas/" method="post" class="map-form">
				<div class="input-map">
					<p class="input-map__text">Адрес</p>
					<input name="address" id="suggest" type="text" placeholder="Москва, Театральный проезд, 5с10">
				</div>
