...
<!-- 
	...
	<div class="reg-block login">
		<div class="reg-cont">
			<p class="reg-cont__title">Сброс пароля</p>
			<p class="reg-cont__text password">Вы получите ссылку для сброса вашего пароля.</p>

			<form action="#" class="reg-form">

				<div class="reg-input">
					<p class="reg-input__text">E-mail</p>
					<input type="email" placeholder="mybesthelper@gmail.com">
				</div>

				<button>Отправить ссылку для сброса</button>
			</form>

			<p class="reg-cont__quest login">Уже есть аккаунт? <a href="">Войти</a></p>
			<p class="reg-cont__quest">Нет аккаунта? <a href="">Зарегистрироваться</a></p>
		</div>
